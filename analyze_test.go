...
// TestAnalyzeDir is now covered by comprehensive integration tests in
// analyze_integration_test.go. The type-aware analyzer requires valid Go
// modules, so these simple temp-directory tests have been replaced with
// tests using the real example projects. See TestAnalyzeDirIntegration.

// TestValidateDeps is now covered by TestValidateDepsIntegration in
// analyze_integration_test.go. The type-aware analyzer requires valid Go
// modules, so these simple temp-directory tests have been replaced with
// tests using the real example projects.
